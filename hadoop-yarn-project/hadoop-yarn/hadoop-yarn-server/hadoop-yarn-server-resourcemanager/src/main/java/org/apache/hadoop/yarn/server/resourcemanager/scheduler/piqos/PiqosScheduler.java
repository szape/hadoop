...
public class PiqosScheduler extends AbstractPiqosScheduler implements
  ...
  public PiqosScheduler() {
    super(PiqosScheduler.class.getName());
  }
...
//    List<UpdateContainerRequest> increaseRequests = Collections.singletonList(increaseRequest);
  ...
  @Override
  public boolean right(Resource capability) {
    System.out.println("### PiqosScheduler received a right request: (" + capability + ")");
    return true;
  }
}
