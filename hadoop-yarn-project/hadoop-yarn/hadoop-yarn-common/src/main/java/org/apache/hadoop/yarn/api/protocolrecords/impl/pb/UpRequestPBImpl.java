...
import org.apache.hadoop.yarn.proto.YarnServiceProtos.UpRequestProtoOrBuilder;

@Public
@Unstable
public class UpRequestPBImpl extends UpRequest {
  UpRequestProto proto = UpRequestProto.getDefaultInstance();
  ...
  public UpRequestPBImpl() {
    builder = UpRequestProto.newBuilder();
  }
  
  public UpRequestPBImpl(UpRequestProto proto) {
    this.proto = proto;
    viaProto = true;
  }
  
  public UpRequestProto getProto() {
    mergeLocalToProto();
